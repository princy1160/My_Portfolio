...
const socialMediaLinks = {
  ...
  // gitlab: "https://gitlab.com/princypatwa",
  // facebook: "https://www.facebook.com/princy.patwa7",
  // medium: "https://medium.com/@princypatwa",
  // stackoverflow: "https://stackoverflow.com/users/10422806/princy-patwa",
...
in Leetcode`,
    ...
    },
    {
      ...
      image: require("./assets/images/Super-30.png"),
      imageAlt: "",
      footerLink: [
        {
...
const blogSection = {
  ...
  blogs: [
    ...
    {
      url: "https://medium.com/@princypatwa/why-react-is-the-best-5a97563f423e",
  ...
  talks: [
    {
      ...
      slides_url: "https://bit.ly/princypatwa-slides",
...
const podcastSection = {
  ...
  podcast: [
    "https://anchor.fm/codevcast/embed/episodes/DevStory---princy-patwa-from-Karachi--Pakistan-e9givv/a-a15itvo"
  ],
  display: false // Set false to hide this section, defaults to true
};
